...
const Resources = () => {
    return (
        <div id="resources">
            <h2 style={{ color: "#4b4994", marginLeft:"30px", marginTop:"20px", fontSize:"20px", fontWeight:"bold"}}>Resources</h2>
            <div className="card-container">
                <div className="card" style={{ width: "300px", borderColor: "#4b4994", backgroundColor: "white" }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title" style={{ color: "#4b4994" }}>Culturally Relevant Resources</h5>
                        <p className="card-text" style={{ color: "#4b4994" }}>Access a diverse range of culturally sensitive resources tailored to the experiences of Black individuals.
                ...
                <div className="card" style={{ width: "300px", borderColor: "#4b4994", backgroundColor: "white" }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title" style={{ color: "#4b4994" }}>Supportive Community</h5>
                        <p className="card-text" style={{ color: "#4b4994" }}> Connect with a vibrant online community of Black individuals who share similar experiences.
                ...
                <div className="card" style={{ width: "300px", borderColor: "#4b4994", backgroundColor: "white" }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title" style={{ color: "#4b4994" }}>Personalized Support</h5>
                        <p className="card-text" style={{ color: "#4b4994" }}>Receive personalized support tailored to your needs.
